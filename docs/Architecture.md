...
- Java, Spring Boot, PostgreSQL, Redis, React, Vite의 구체 버전 확정
- Refresh Token 회전 정책과 폐기 정책 상세화
- Redis 장애 시 WebSocket 재연결 UX 상세화
- CORS, 쿠키 도메인, SameSite 정책 상세화
- 파일 MIME 허용 범위와 저장소 키 규칙 확정
